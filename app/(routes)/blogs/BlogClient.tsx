  ...
  return (
    <section className="w-full overflow-hidden ">
      ...
      <div className="mb-8 px-4 py-8 text-center shadow-sm md:mb-16">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-textDarkPrimary md:text-4xl">{heading}</h1>
      </div>
      <div className="mx-auto  max-w-7xl px-4">
        <div className="mb-6">
          <h2 className="mb-3 text-lg font-medium text-gray-900 dark:text-textDarkPrimary">Categories</h2>
        ...
        <div className="flex min-h-screen flex-col gap-4 pb-8">
          {filteredPosts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              <div className="mb-4 animate-bounce text-3xl font-light text-textPrimary dark:text-textDarkPrimary">✧</div>
              <p className="text-lg font-light tracking-wide text-textPrimary dark:text-textDarkPrimary">No articles found in this category</p>
              <p className="mt-2 text-sm text-textSecondary dark:text-textDarkSecondary">Try selecting a different category</p>
            </div>
          )}
        </div>
      </div>
